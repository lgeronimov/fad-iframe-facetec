    ...
    moduleCustomization: {
        legends: {
            ...
            facetec: {
                ...
                enterFullscreenHeader: 'Prueba de vida_1',
                enterFullscreenMessage: 'Antes de comenzar da clic en el botón de abajo para abrir en pantalla completa_1',
                enterFullscreenAction: 'Continuar_1'
            }
        }
    }
}
...
window.addEventListener("message", (message) => {
    ...
    if (message.data.event === EVENT_MODULE.PROCESS_INIT) { // PROCESS_INIT
        ...
        const status = message.data.data.status;
